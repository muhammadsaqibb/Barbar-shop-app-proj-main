...
const MobileServiceCard = ({ service, onToggle, onEdit, onDelete, formatPrice }: { service: Service, onToggle: (service: Service) => void, onEdit: (service: Service) => void, onDelete: (serviceId: string) => void, formatPrice: (amount: number) => string }) => (
    <Card>
        <CardHeader>
            ...
            <div className="flex justify-between">
                ...
                {service.discountedPrice && service.discountedPrice > 0 ? (
                    <div className="flex flex-col items-end">
                        <span className="line-through text-muted-foreground text-xs">{formatPrice(service.price)}</span>
                        <span className="font-bold">{formatPrice(service.discountedPrice)}</span>
                    </div>
                ) : (
                    <span className="font-bold">{formatPrice(service.price || 0)}</span>
                )}
            </div>
            <div className="flex justify-between">
